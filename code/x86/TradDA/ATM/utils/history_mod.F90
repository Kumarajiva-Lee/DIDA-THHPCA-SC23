  ...
  subroutine history_init( group_id_in)
    ...
    do im = 1 , member_total
      ...
      if (baroclinic) then
        ...
        call fiona_add_var(fid0, 'u_lon'    , long_name='u wind component'            , units='m s-1'  , dim_names=lon_dims, data_type='real(8)')
        call fiona_add_var(fid0, 'v_lat'    , long_name='v wind component'            , units='m s-1'  , dim_names=lat_dims, data_type='real(8)')
        ...
        call fiona_add_var(fid0, 'u_lon'    , long_name='u wind component'            , units='m s-1'  , dim_names=lon_dims_2d, data_type='real(8)')
        call fiona_add_var(fid0, 'v_lat'    , long_name='v wind component'            , units='m s-1'  , dim_names=lat_dims_2d, data_type='real(8)')
  ...
  subroutine history_write_state(blocks, itime, group_id_in , new_file)
    ...
    do im = 1 , member_num
      ...
      do iblk = 1, size(blocks)
        ...
        call fiona_output(fid0, 'u_lon'   , state%u_lon   (im,is:ie,js:je,ks:ke), start=start, count=count)
        ...
        call fiona_output(fid0, 'v_lat'   , state%v_lat   (im,is:ie,js:je,ks:ke), start=start, count=count)
