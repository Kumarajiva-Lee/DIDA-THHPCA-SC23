module dynamics_types_mod
  ...
  contains
    ...
    subroutine dstate_init(this, mesh)
      ...
      call allocate_array(mesh, this%u                , member_num, full_lon=.true., full_lat=.true., full_lev=.true.)
      call allocate_array(mesh, this%v                , member_num, full_lon=.true., full_lat=.true., full_lev=.true.)
      call allocate_array(mesh, this%u_lon            , member_num, half_lon=.true., full_lat=.true., full_lev=.true.)
      call allocate_array(mesh, this%v_lon            , member_num, half_lon=.true., full_lat=.true., full_lev=.true.)
      call allocate_array(mesh, this%u_lat            , member_num, full_lon=.true., half_lat=.true., full_lev=.true.)
      call allocate_array(mesh, this%v_lat            , member_num, full_lon=.true., half_lat=.true., full_lev=.true.)
      call allocate_array(mesh, this%we_lev           , member_num, full_lon=.true., full_lat=.true., half_lev=.true.)
      call allocate_array(mesh, this%we_lev_lon       , member_num, half_lon=.true., full_lat=.true., half_lev=.true.)
      call allocate_array(mesh, this%we_lev_lat       , member_num, full_lon=.true., half_lat=.true., half_lev=.true.)
      ...
      call allocate_array(mesh, this%mfx_lon          , member_num, half_lon=.true., full_lat=.true., full_lev=.true.)
      call allocate_array(mesh, this%mfy_lon          , member_num, half_lon=.true., full_lat=.true., full_lev=.true.)
      call allocate_array(mesh, this%mfy_lat          , member_num, full_lon=.true., half_lat=.true., full_lev=.true.)
      call allocate_array(mesh, this%mfx_lat          , member_num, full_lon=.true., half_lat=.true., full_lev=.true.)
      ...
      call allocate_array(mesh, this%ptf_lon          , member_num, half_lon=.true., full_lat=.true., full_lev=.true.)
      call allocate_array(mesh, this%ptf_lat          , member_num, full_lon=.true., half_lat=.true., full_lev=.true.)
      call allocate_array(mesh, this%ptf_lev          , member_num, full_lon=.true., full_lat=.true., half_lev=.true.)
      ...
      call allocate_array(mesh, this%ph_exn_lev       , member_num, full_lon=.true., full_lat=.true., half_lev=.true.)
      ...
      if (baroclinic) then
        call allocate_array(mesh, this%qm             , member_num, full_lon=.true., full_lat=.true., full_lev=.true.)
      end if
  
      if (nonhydrostatic) then
        call allocate_array(mesh, this%we             , member_num, full_lon=.true., full_lat=.true., full_lev=.true.)
      ...
      if (use_smag_damp) then
        call allocate_array(mesh, this%smag_t       , member_num, full_lon=.true., full_lat=.true., full_lev=.true.)
        call allocate_array(mesh, this%smag_s       , member_num, half_lon=.true., half_lat=.true., full_lev=.true.)
    ...
    subroutine dtend_init(this, mesh)
      ...
      if (use_smag_damp) then
        call allocate_array(mesh, this%smag_dptdt, member_num, full_lon=.true., full_lat=.true., full_lev=.true.)
        call allocate_array(mesh, this%smag_dudt , member_num, half_lon=.true., full_lat=.true., full_lev=.true.)
        call allocate_array(mesh, this%smag_dvdt , member_num, full_lon=.true., half_lat=.true., full_lev=.true.)
      end if
  
      call allocate_array(mesh, this%adv_gz_lon, member_num, full_lon=.true., full_lat=.true., half_lev=.true.)
      call allocate_array(mesh, this%adv_gz_lat, member_num, full_lon=.true., full_lat=.true., half_lev=.true.)
      call allocate_array(mesh, this%adv_gz_lev, member_num, full_lon=.true., full_lat=.true., half_lev=.true.)
      call allocate_array(mesh, this%adv_w_lon , member_num, full_lon=.true., full_lat=.true., half_lev=.true.)
      call allocate_array(mesh, this%adv_w_lat , member_num, full_lon=.true., full_lat=.true., half_lev=.true.)
      call allocate_array(mesh, this%adv_w_lev , member_num, full_lon=.true., full_lat=.true., half_lev=.true.)
  
      call allocate_array(mesh, this%dudt_phys , member_num, full_lon=.true., full_lat=.true., full_lev=.true.)
      call allocate_array(mesh, this%dvdt_phys , member_num, full_lon=.true., full_lat=.true., full_lev=.true.)
      call allocate_array(mesh, this%dtdt_phys , member_num, full_lon=.true., full_lat=.true., full_lev=.true.)
      call allocate_array(mesh, this%dshdt_phys, member_num, full_lon=.true., full_lat=.true., full_lev=.true.)
    ...
    subroutine static_init(this, mesh)
      ...
      call allocate_array(mesh, this%landmask, member_num, full_lon=.true., full_lat=.true.)
      call allocate_array(mesh, this%gzs     , member_num, full_lon=.true., full_lat=.true.)
      call allocate_array(mesh, this%zs_std  , member_num, full_lon=.true., full_lat=.true.)
      call allocate_array(mesh, this%dzsdlon , member_num, half_lon=.true., full_lat=.true.)
      call allocate_array(mesh, this%dzsdlat , member_num, full_lon=.true., half_lat=.true.)
      call allocate_array(mesh, this%ref_ps  , member_num, full_lon=.true., full_lat=.true.)
